...
public class CalculatorTesting {
	...
	public static void testingEvaluateMore()
	{
		...
		{
		System.out.println("\nInput: ((9%0)%0)");
		Calculator mod3 = new Calculator("((9%0)%0)");
		System.out.println("Expected: Can not divide by 0");
		System.out.println("Actual:   " + mod3.evaluate());
		}
		catch(ArithmeticException Ae)
	...
	public static void testingGetPostFix()
	{
		...
		Calculator sub = new Calculator("((1-2)-1)");
		Calculator mult = new Calculator("((1*2)*1)");
		Calculator div = new Calculator("((1/2)/1)");
		Calculator mod = new Calculator("((1%2)%1)");
		Calculator exc = new Calculator("(((1+2)+1)");

		System.out.println("\nConverting ((1+2)+1) to PostFix:");
		System.out.println("Expected: 12+1+");
		...
		System.out.println("Expected: 12-1-");
		System.out.print("Actual:   ");
		System.out.println(sub.getPostFix());
		
		System.out.println("\nConverting ((1*2)*1) to PostFix:");
		System.out.println("Expected: 12*1*");
		System.out.print("Actual:   ");
		System.out.println(mult.getPostFix());
		
		System.out.println("\nConverting ((1/2)/1) to PostFix:");
		System.out.println("Expected: 12/1/");
		System.out.print("Actual:   ");
		System.out.println(div.getPostFix());
		
		System.out.println("\nConverting ((1%2)%1) to PostFix:");
		System.out.println("Expected: 12%1%");
		System.out.print("Actual:   ");
		System.out.println(mod.getPostFix());
			
		try
		{
			System.out.println("\nConverting (((1+2)+1) to PostFix:");
			System.out.println("Expected: Could not convert to PostFix");
			System.out.print("Actual:   ");
			System.out.println(exc.getPostFix());
		}
		catch(Exception e)
		{
